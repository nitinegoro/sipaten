...
class Msurat_keluar extends Sipaten_model 
{
	...
	{
		$this->db->select('
			surat.*, kategori_surat.*, penduduk.nik, penduduk.nama_lengkap, penduduk.pekerjaan, penduduk.tmp_lahir, penduduk.tgl_lahir, penduduk.no_kk, penduduk.status_kk, penduduk.agama, penduduk.alamat, penduduk.gol_darah, penduduk.rt, penduduk.rw, penduduk.jns_kelamin, penduduk.status_kawin, penduduk.kewarganegaraan, desa.nama_desa, pegawai.nama, pegawai.jabatan, pegawai.nip, penduduk.telepon'
		);
