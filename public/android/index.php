...
<div class="navbar-fixed">
  <nav class="nav-extended orange darken-3 " >
    <div class="nav-wrapper navbar-fixed" style="background-image: url('images/bg.png'); height: 70px">
      ...
      <a href="#" class="brand-logo"><img class="responsive-img" src="images/logo.png" alt=""></a>
      ...
      <ul class="side-nav" id="mobile-demo">
        <li><a href="sass.html">Sassdsd</a></li>
        <li><a href="badges.html">Components</a></li>
        <li><a href="collapsible.html">JavaScript</a></li>
      </ul>
    ...
    <div class="nav-content" >
      <ul class="tabs tabs-transparent" style="background-color: #A64305 ;">
...
<ul id="slide-out" class="side-nav">
  ...
  <div id="test1" class="col s12">
    ...
    <a class="carousel-item" href="#four!"><img src="https://lorempixel.com/800/400/food/4"></a>
        ...
        <br><br>
        <h1 class="header center orange-text">Beranda </h1>
  ...
  <div id="test2" class="col s12">
    <div class="section no-pad-bot" id="index-banner" >
      <div class="container" >
        ...
        <div class="row center">
          <h5 class="header col s12 light">A modern sasa front-end framework based on Material Design</h5>
        </div>
        <div class="row center">
          <a href="#" id="download-button" class="btn-large waves-effect waves-light orange">Get Started</a>
        </div>
  ...
  <div id="test4" class="col s12">
    <div class="section no-pad-bot" id="index-banner" >
      <div class="container" >
        <br><br>
        <h1 class="header center orange-text">Profil</h1>
        <div class="row center">
          <h5 class="header col s12 light">A modern responsive front-end framework based on Material Design</h5>
        </div>
        <div class="row center">
  ...
  <footer class="page-footer orange">
    ...
    <div class="footer-copyright">
      <div class="container">
      Made by <a class="orange-text text-lighten-3" href="http://teitramega.co.id">Teitra Mega</a>
      </div>
    </div>
  </footer>
